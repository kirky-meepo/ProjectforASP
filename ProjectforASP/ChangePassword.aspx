<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="CloudMoney.ChangePassword" %>
...
<div style="width:100%; min-height:100vh; display:flex; justify-content:center; align-items:center;">
    ...
    <div style="width:1180px; min-height:700px; background:#eeeeee; border-radius:18px; box-shadow:0px 10px 35px rgba(0,0,0,0.25); display:flex; overflow:hidden;">
        ...
        <div style="width:210px; background:white; margin:22px; border-radius:18px; padding:25px 18px;">
            ...
            <asp:HyperLink runat="server" NavigateUrl="~/ChangePassword.aspx" style="display:block; background:#111; color:white; padding:13px 18px; border-radius:10px; text-decoration:none; font-weight:bold;">Change Password</asp:HyperLink>
        ...
        <div style="flex:1; padding:55px 45px 35px 5px;">

            <h1 style="margin:0 0 25px 0; font-size:34px;">Change Password</h1>

            <div style="display:flex; gap:22px;">

                <div style="width:470px; background:white; border-radius:18px; padding:35px; box-shadow:0px 3px 12px rgba(0,0,0,0.08);">

                    <h2 style="margin-top:0;">Update Password</h2>
                    <p style="color:#555;">Enter your current password and create a new one.</p>

                    <asp:TextBox ID="txtCurrent" runat="server" TextMode="Password"
                        placeholder="Current Password"
                        style="width:390px; padding:14px; border-radius:12px; border:1px solid #cccccc; font-size:12pt;">
                    </asp:TextBox>
                    ...
                    <asp:Button ID="btnChange" runat="server" Text="Change Password"
                        ...
                        style="width:420px; background:#111; color:white; border:none; padding:14px; border-radius:12px; font-weight:bold; cursor:pointer; font-size:12pt;" />
                ...
                <div style="flex:1; background:#111; color:white; border-radius:18px; padding:35px; box-shadow:0px 3px 12px rgba(0,0,0,0.12);">
                    ...
                    <h2 style="margin-top:0;">Security Reminder</h2>

                    <p style="font-size:18px; margin-top:25px;">Use a password that is easy for you to remember but hard for others to guess.</p>

                    <div style="background:#222; border-radius:14px; padding:22px; margin-top:25px;">
                        <p>Do not share your password with anyone.</p>
                        <p>Make sure your new password and confirm password match.</p>
                        <p style="margin-bottom:0;">Log out after changing your password if you are using a shared computer.</p>
                    </div>
