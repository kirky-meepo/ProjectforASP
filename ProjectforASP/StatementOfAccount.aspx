<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StatementOfAccount.aspx.cs" Inherits="CloudMoney.StatementOfAccount" %>
...
<div style="width:100%; min-height:100vh; display:flex; justify-content:center; align-items:center;">
    ...
    <div style="width:1180px; min-height:700px; background:#eeeeee; border-radius:18px; box-shadow:0px 10px 35px rgba(0,0,0,0.25); display:flex; overflow:visible;">
        ...
        <div style="width:210px; background:white; margin:22px; border-radius:18px; padding:25px 18px;">
            ...
            <asp:HyperLink runat="server" NavigateUrl="~/StatementOfAccount.aspx" style="display:block; background:#111; color:white; padding:13px 18px; border-radius:10px; text-decoration:none; font-weight:bold;">Statement</asp:HyperLink>
        ...
        <div style="flex:1; padding:50px 35px 35px 5px; overflow:auto;">
            ...
            <h1 style="margin:0 0 25px 0; font-size:34px;">My Statement of Account</h1>
                ...
                <div style="display:flex; gap:18px; align-items:end;">
                    <div>
                        ...
                        <asp:TextBox ID="txtFrom" runat="server" placeholder="MM/DD/YYYY"
                            style="width:220px; padding:13px; border-radius:10px; border:1px solid #cccccc; font-size:11pt;">
                        </asp:TextBox>
                    </div>
            ...
            <div style="background:white; border-radius:18px; padding:28px; box-shadow:0px 3px 12px rgba(0,0,0,0.08);">
                ...
                <asp:GridView ID="gvStatement" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="BalanceAfter" HeaderText="Balance" />
