<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SentReceivedReport.aspx.cs" Inherits="CloudMoney.SentReceivedReport" %>
...
<div style="width:100%; min-height:100vh; display:flex; justify-content:center; align-items:center;">
    ...
    <div style="width:1180px; min-height:700px; background:#eeeeee; border-radius:18px; box-shadow:0px 10px 35px rgba(0,0,0,0.25); display:flex; overflow:visible;">
        ...
        <div style="width:210px; background:white; margin:22px; border-radius:18px; padding:25px 18px;">
            ...
            <asp:HyperLink runat="server" NavigateUrl="~/SentReceivedReport.aspx" style="display:block; background:#111; color:white; padding:13px 18px; border-radius:10px; text-decoration:none; font-weight:bold;">Sent / Received</asp:HyperLink>
        ...
        <div style="flex:1; padding:50px 35px 35px 5px; overflow:auto;">
            ...
            <h1 style="margin:0 0 25px 0; font-size:34px;">My Sent or Received Transactions</h1>
